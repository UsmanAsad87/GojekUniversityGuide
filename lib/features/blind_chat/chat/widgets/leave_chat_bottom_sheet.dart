      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            children: [
              Text(
                'are you sure you want to leave blindchat?',
                textAlign: TextAlign.center,
                style: getBoldStyle(fontSize: MyFonts.size16,color: MyColors.black,isMontserrat: true),
              ),
              SizedBox(
                height: 16.h,
              ),
              ...
              Text(
                'closing will end any chats, you can always come back and start finding new pals again',
                textAlign: TextAlign.center,
                style: getMediumStyle(fontSize: MyFonts.size14 ,isMontserrat: true),
              ),
            ],
          ),
        ),
