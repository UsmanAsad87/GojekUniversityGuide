...
class BlindChatHomeScreen extends ConsumerWidget {
  ...
  onSwipe(WidgetRef ref, BuildContext context) {
    ...
    if (instagramHandle == '' && interests.isEmpty) {
      const msg = 'Your interests and instagram handle are not set, Kindly setup interests and instagram handle to join blind Chat!';
      showAwesomeSnackBar(
          context: context,
    ...
    if (instagramHandle == '') {
      const msg =
          'Your instagram handle are not set, Kindly setup instagram handle to join blind Chat!';
      showAwesomeSnackBar(
          context: context,
    ...
    if ((interests.isEmpty)) {
      const msg =
          'Your interests are not set, Kindly setup interests to join blind Chat!';
      showAwesomeSnackBar(
          context: context,
