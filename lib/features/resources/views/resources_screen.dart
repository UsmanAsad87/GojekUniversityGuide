      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text('We’ve got you covered with our resources!', style: getBoldStyle(
                ...
                children: [
                    ...
                    child: Consumer(
                      builder: (BuildContext context, WidgetRef ref, Widget? child) {
                        return ResourcesWidget(
                          ...
                          onTap: () {
                            ref.watch(getCampusParkingChecklistUrlProvider).when(
                                data: (url){
                                  Navigator.pushNamed(
                                      context,
                                      ...
                                      arguments: {
                                        'newUrl' : url.url,
                                        'pageTitle' : 'campus parking checklist',
                                      });
                                },
                                error: (error, st){
                  ...
                  Positioned(
                    ...
                    child: ResourcesWidget(
                      ...
                      title: 'chatbot',
                      onTap: () {
                        Navigator.pushNamed(context, AppRoutes.resourceChatBotScreen);
                      },
                      index: 2,
                    ),
                  ),
